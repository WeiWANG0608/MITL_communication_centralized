...
public class MITL_verification {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String abspath = "/home/wei/PycharmProjects/MITL_communication/MITL_communication";
	String abspath = "/home/wei/PycharmProjects/MITL_communication_centralized/MITL_communication_centralized";
        ...
        String direction = abspath+"/files";
		...
		Long threadTime = 0L;
                ...
                while (fooveri.getValue() == null){
			threadTime = System.currentTimeMillis() - startThread;
                	if (threadTime.floatValue() > 10000){
                		break;
                	}
                }
		...
		System.out.println("Time from thread: " + threadTime);
                thread.interrupt();
                // printTrace(sys, strace);
